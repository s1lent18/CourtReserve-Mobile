...
fun UserTournamentPage(
    ...
    val getSingleTournamentResponse = tournamentViewModel.getSingleTournamentResult.collectAsState().value
    ...
    Scaffold(
        ...
        LaunchedEffect(userData) {
            if (userData != null) {
                tournamentViewModel.getSingleTournament(
